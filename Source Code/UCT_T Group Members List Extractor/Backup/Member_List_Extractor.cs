...
namespace Commerce_Group_Members_List_Extractor
{
	/// <summary>
	/// Commerce Group Members List Extractor is a simple application that allows an 
	...
	///
	/// Usage: Commerce Group Members List Extractor.exe GROUP_OBJECT where GROUP_OBJECT 
	...
	class Member_List_Extractor
	{
		...
		static void Main(string[] args)
		{
			...
			{
				Console.WriteLine("Usage: Commerce Group Members List Extractor.exe GROUP_OBJECT");
				Console.WriteLine("where GROUP_OBJECT is the group (e.g. CF_ALLSTAFF_G) you wish to extract member names from. The * character acts like a wildcard character.") ;
